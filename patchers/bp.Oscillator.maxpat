...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.579285000000027, 196.710144000000014, 74.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 116.579285000000027, 166.710144000000014, 74.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.579285000000027, 226.710144000000014, 49.0, 22.0 ],
					"text" : "receive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 46.579285000000027, 276.710144000000014, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.579285000000027, 274.710144000000014, 74.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 156.579285000000027, 244.710144000000014, 74.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.579285000000027, 304.710144000000014, 49.0, 22.0 ],
					"text" : "receive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 86.579285000000027, 354.710144000000014, 142.0, 22.0 ],
					"restore" : 					{
						"CV2" : [ 0.0 ],
						"CV3" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 163.286697387695313, 48.221527099609375, 54.919864654541016, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
		...
		"parameters" : 		{
			"obj-106" : [ "CV3[2]", "CV3", 0 ],
			"obj-107" : [ "Linear[1]", "Linear", 0 ],
			"obj-11" : [ "PWM", "PWM", 0 ],
			"obj-129" : [ "CV2[2]", "CV2", 0 ],
			"obj-36" : [ "PW", "PW", 0 ],
			"obj-4" : [ "Waveform", "Waveform", 0 ],
			"obj-45" : [ "FreqMode[1]", "FreqMode", 0 ],
			"obj-46" : [ "Offset[2]", "Offset", 0 ],
			"obj-51" : [ "Freq[2]", "Freq", 0 ],
			"obj-53" : [ "Mute[4]", "Mute", 0 ],
			"parameterbanks" : 			{
